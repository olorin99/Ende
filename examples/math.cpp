...
int main() {
    ...
    auto v0 = ende::math::float4x4(std::to_array({std::to_array({1.f, 0.f, 0.f, 0.f}),
                                                  std::to_array({1.f, 0.f, 0.f, 0.f}),
                                                  std::to_array({1.f, 0.f, 0.f, 0.f}),
                                                  std::to_array({1.f, 0.f, 0.f, 0.f})}));
    // auto v1 = ende::math::v2::identity<f32, 4, 4>();
    auto v1 = ende::math::float4x4({2.f, 4.f, 5.f, 5.f,
                                    66.f, 2.f, 2.f, 4.f,
                                    4.f, 12.f, 23.f, 56.f,
                                    6.f, 9.f, 1.f, 4.f});
    ...
    auto v7 = ende::math::Matrix<f32, 4, 2>({1.f, 303.f,
                                             5.f, -2.f,
                                             0.54f, 4000.f,
                                             10.f, 3.f});
