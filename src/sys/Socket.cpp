...
export module ende.system.Socket;

import ende.util;

namespace ende::sys {

export typedef sockaddr Address;
export typedef addrinfo AddressInfo;

export auto getAddressInfo(const std::string &node, const std::string &service) -> AddressInfo;
...
export auto getPeerName(const Socket &socket, Address &address) -> bool;

export auto getHostName() -> std::string;
