...
export module ende.math.Matrix;

import ende.util;

namespace ende::math {

export template <u32 M, u32 N>
...
export template <typename T, u32 M, u32 N = M>
class Matrix {
  public:
...
export template <typename T, typename U, u32 M, u32 N = M>
...
export using float2x2 = Matrix<f32, 2, 2>;
export using float3x3 = Matrix<f32, 3, 3>;
export using float4x4 = Matrix<f32, 4, 4>;

export using float2 = Matrix<f32, 2, 1>;
export using float3 = Matrix<f32, 3, 1>;
export using float4 = Matrix<f32, 4, 1>;

export using int2 = Matrix<i32, 2, 1>;
export using int3 = Matrix<i32, 3, 1>;
export using int4 = Matrix<i32, 4, 1>;

export using uint2 = Matrix<u32, 2, 1>;
export using uint3 = Matrix<u32, 3, 1>;
export using uint4 = Matrix<u32, 4, 1>;
